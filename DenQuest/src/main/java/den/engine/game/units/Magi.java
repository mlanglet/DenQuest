...
public class Magi extends Unit {
	...
	protected void init(){
		...
		texture.setTextureSource("res/images/units/magi_sheet.png");
	...
	private void tickWeapon(float delta) {
		if(!isShooting && game.getPlayer().isAlive()){
			isShooting = true;
			new Projectile(game, this, game.getPlayer().getPosition(), getDamage(), DAMAGE_TYPE.MAGIC);
		}
